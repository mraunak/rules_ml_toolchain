...
REDIST_DICT = {
    "oneapi": {
        "ubuntu_24.10_2025.3": [
            "https://tensorflow-file-hosting.s3.us-east-1.amazonaws.com/intel-oneapi-base-toolkit-2025.3.1.36.tar.gz",
            "cd45a1660f3510fe8e78800c3f36c7f0304626cc4819a443c09dda1eb24e8f9d",
            "oneapi",
        ],
        "ubuntu_24.04_2025.1": [
...
BUILD_TEMPLATES = {
    "oneapi": {
        ...
        "version_to_template": {
	        ...
	        "ubuntu_24.10_2025.3": "//gpu/sycl:oneapi.BUILD",
        },
    },
    "level_zero": {
	    ...
	    "ubuntu_24.10_2025.3": "//gpu/sycl:level_zero.BUILD",
        },
    },
    "zero_loader": {
	    ...
	    "ubuntu_24.10_2025.3": "//gpu/sycl:zero_loader.BUILD",
        },
    },
}
