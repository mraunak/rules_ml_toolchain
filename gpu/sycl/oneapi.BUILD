...
filegroup(
    ...
    srcs = glob([
            ...
            "ipp/2022.3/include/**",
            "ipp/2022.3/lib/lib*",
            "ipp/2022.3/lib/nonpic/**",
            "ipp/2022.3/lib/pkgconfig/**",
            "ipp/2022.3/opt/**",
            "ipp/2022.3/share/**",
...
cc_library(
    ...
    srcs = glob([
        ...
        "{oneapi_version}/lib/libhwloc.so*".format(oneapi_version = ONEAPI_VERSION),
        "{oneapi_version}/lib/libur_loader.so*".format(oneapi_version = ONEAPI_VERSION),
        "{oneapi_version}/lib/libur_adapter_level_zero_v2.so*".format(oneapi_version = ONEAPI_VERSION),
